  ...
  static MessagesRobocupSslWrapperReflection() {
    byte[] descriptorData = global::System.Convert.FromBase64String(
        string.Concat(
          ...
          "ZXRyeRgCIAEoCzIRLlNTTF9HZW9tZXRyeURhdGFiBnByb3RvMw=="));
    descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
        ...
        new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
          new pbr::GeneratedClrTypeInfo(typeof(global::SSL_WrapperPacket), global::SSL_WrapperPacket.Parser, new[]{ "Detection", "Geometry" }, null, null, null)
        }));
  }
  #endregion
...
public sealed partial class SSL_WrapperPacket : pb::IMessage<SSL_WrapperPacket> {
  ...
  public void MergeFrom(SSL_WrapperPacket other) {
    ...
    if (other.geometry_ != null) {
      if (geometry_ == null) {
        geometry_ = new global::SSL_GeometryData();
      }
