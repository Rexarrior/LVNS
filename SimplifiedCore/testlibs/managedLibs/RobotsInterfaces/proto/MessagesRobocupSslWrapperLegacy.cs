...
namespace RoboCup2014Legacy.Wrapper {
    ...
    static MessagesRobocupSslWrapperLegacyReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::RoboCup2014Legacy.Wrapper.SSL_WrapperPacket), global::RoboCup2014Legacy.Wrapper.SSL_WrapperPacket.Parser, new[]{ "Detection", "Geometry" }, null, null, null)
          }));
    }
    #endregion
  ...
  public sealed partial class SSL_WrapperPacket : pb::IMessage<SSL_WrapperPacket> {
    ...
    public SSL_WrapperPacket(SSL_WrapperPacket other) : this() {
      Detection = other.detection_ != null ? other.Detection.Clone() : null;
    ...
    public void MergeFrom(SSL_WrapperPacket other) {
      ...
      if (other.detection_ != null) {
        if (detection_ == null) {
          detection_ = new global::SSL_DetectionFrame();
        }
        Detection.MergeFrom(other.Detection);
      }
      if (other.geometry_ != null) {
        if (geometry_ == null) {
          geometry_ = new global::RoboCup2014Legacy.Geometry.SSL_GeometryData();
        }
